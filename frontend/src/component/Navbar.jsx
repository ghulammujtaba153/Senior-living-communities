      ...
      <div className="max-w-[1200px] mx-auto py-2 font-size-14 h-[57px] relative">
        <div className="flex justify-between items-center h-full">
          ...
          <div className='flex items-center gap-4'>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link to="/communities" className="hover:text-[#BEE36E] transition-colors duration-300">Communities</Link>
              <Link to="/resources" className="hover:text-[#BEE36E] transition-colors duration-300">Resources</Link>
              <Link to="/about" className="hover:text-[#BEE36E] transition-colors duration-300">About Us</Link>
          ...
          {user ? (
            <div className='flex items-center gap-4'>
              ...
              <button onClick={logout} className='bg-[#BEE36E] text-black px-4 py-2 rounded-md'>Logout</button>
            </div>
          ) : (
            <div className='flex items-center gap-4'>
              <Link to="/signin" className='bg-[#BEE36E] text-black px-4 py-2 rounded-md'>Login</Link>
              <Link to="/signup" className='bg-[#BEE36E] text-black px-4 py-2 rounded-md'>Signup</Link>
            </div>
          )}
        ...
        `}>
          <div className="flex flex-col p-4 gap-4">
              <Link to="/" className="hover:text-[#BEE36E] transition-colors duration-300">Home</Link>
              <Link to="/about" className="hover:text-[#BEE36E] transition-colors duration-300">Community</Link>
              <Link to="/contact" className="hover:text-[#BEE36E] transition-colors duration-300">Resources</Link>
