...
const FAQsSection: React.FC = () => {
    const questions = [
        ...
        {
            question: "Can I contact communities directly?",
            answer: "Yes, each community profile includes direct contact information so you can connect without involving placement agencies."
        }
    ];
