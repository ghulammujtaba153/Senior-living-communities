            ...
            <section className="max-w-[1200px] mx-auto p-6 md:p-10 font-sans text-gray-700 mt-[80px]">
                ...
                {resources.map((section, index) => (
                    <div key={index} className="mb-12">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="text-[#BEE36E]">
                                {section.icon}
                            </div>
                            <h2 className="text-2xl font-bold text-[#BEE36E]">
                                {section.category}
                            </h2>
                        </div>
                            ...
                            {section.items.map((item, idx) => (
                                <div key={idx} className="bg-white shadow-lg rounded-xl overflow-hidden transition-transform hover:scale-[1.02]">
                                    <div className="flex items-start p-6">
                                        <div className="text-[#BEE36E] mr-4 mt-1">
                                            {item.icon}
                                        </div>
                                        <div>
                ...
                <div className="mt-12 bg-white rounded-xl p-8 shadow-lg">
                    <div className="flex items-center gap-4 mb-4">
                        <QuestionMarkCircleIcon className="w-8 h-8 text-[#BEE36E]" />
                        <h2 className="text-2xl font-bold text-[#BEE36E]">
                            Need More Help?
                        </h2>
                    </div>
                    ...
                    <button className="bg-[#BEE36E] text-white px-6 py-3 rounded-lg hover:bg-opacity-90 transition-colors flex items-center gap-2">
