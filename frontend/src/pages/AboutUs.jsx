        ...
        <div className="bg-gray-50">
            <section className="max-w-[1200px] mx-auto p-6 md:p-10 font-sans text-gray-700 mt-[80px]">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-3xl md:text-5xl font-bold text-[#BEE36E] mb-6">
                        About Us
                    </h1>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <p className="text-lg leading-relaxed mb-6">
                            At <span className="text-[#BEE36E] font-semibold">Senior Living Communities</span>, our mission 
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {values.map((value, index) => (
                            <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                                <div className="text-[#BEE36E] mb-4">
                                    {value.icon}
                                </div>
                ...
                {/* Call to Action */}
                <div className="text-center bg-[#BEE36E] bg-opacity-10 rounded-xl p-8">
                    ...
                    <Link to="/communities" className="bg-[#BEE36E] text-white px-8 py-3 rounded-lg hover:bg-opacity-90 transition-colors">
                        Search Communities
                    </Link>
                </div>
            </section>
